...
# Prepare payload as per user's message for clock out
...
# Also try with type OUT
print('\\n--- Trying with type OUT ---')
payload_out = {
    'EMP_ID': employee_id,
    'SOURCE': 'Web',
    'DATE': date_str,
...
print(f'Status with type OUT: {resp2.status_code}')
print(f'Response: {resp2.text}')

# Also try with source in uppercase
print('\\n--- Trying with SOURCE: WEB ---')
payload_web = {
    'EMP_ID': employee_id,
    'SOURCE': 'WEB',
    'DATE': date_str,
...
print(f'Status with SOURCE WEB: {resp3.status_code}')
